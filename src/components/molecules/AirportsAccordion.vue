...
const accordions = computed(() => [
  {
    ...
    transportText1: t(
      currentLocale.value,
      "travel.airports.accordion.alc.transport1"
    ),
    transportText2: t(
      currentLocale.value,
      "travel.airports.accordion.alc.transport2"
    ),
    transportText3: "",
  ...
  },
  {
    ...
    transportText1: t(
      currentLocale.value,
      "travel.airports.accordion.rmu.transport1"
    ),
    transportText2: t(
      currentLocale.value,
      "travel.airports.accordion.rmu.transport2"
    ),
    transportText3: t(
      currentLocale.value,
      "travel.airports.accordion.rmu.transport3"
    ),
  ...
  <div class="airport-accordion">
    <div class="accordion-item" v-for="(accordion, i) in accordions" :key="i">
      ...
      <div class="accordion-answer" v-show="openIndex === i">
        ...
        ></iframe>
        <h5 class="subtitle-dancing-h3">
          {{ t(currentLocale, "travel.airports.accordion.publicTransport") }}
        </h5>
        ...
        <h5 class="subtitle-dancing-h3">
          {{ t(currentLocale, "travel.airports.accordion.carRental") }}
        </h5>
        <p>
          {{ t(currentLocale, "travel.airports.accordion.carTxt") }}
          {{ accordion.airportAcron }}:
        </p>
